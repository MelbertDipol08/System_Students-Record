...
appLabel = tk.Label(root, text="Students Record", fg="#08a089", width=40)
...
nameLabel = tk.Label(root, text="Student full name", width=20, anchor='w',
                     font=("Sylfaen", 12)).grid(row=1, column=0, padx=(10,0),
                                                pady=(30, 0))
collegeLabel = tk.Label(root, text="Name of your School", width=20, anchor='w',
                        font=("Sylfaen", 12)).grid(row=2, column=0, padx=(10,0))
phoneLabel = tk.Label(root, text="Enter your phone number", width=20, anchor='w',
                      font=("Sylfaen", 12)).grid(row=3, column=0, padx=(10,0))
addressLabel = tk.Label(root, text="Enter your address", width=20, anchor='w',
                        font=("Sylfaen", 12)).grid(row=4, column=0, padx=(10,0))

nameEntry = tk.Entry(root, width = 60)
collegeEntry = tk.Entry(root, width = 60)
phoneEntry = tk.Entry(root, width = 60)
addressEntry = tk.Entry(root, width = 60)

nameEntry.grid(row=1, column=1, padx=(20,500), pady=(50, 20))
collegeEntry.grid(row=2, column=1, padx=(20,500), pady = 20)
phoneEntry.grid(row=3, column=1, padx=(20,500), pady = 20)
addressEntry.grid(row=4, column=1, padx=(20,500), pady = 20)
...
displayButton = tk.Button(root, text="View Records", command=lambda :destroyRootWindow())
